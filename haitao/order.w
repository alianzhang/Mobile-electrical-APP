...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:19px;top:-7px;" onParamsReceive="modelParamsReceive"> 
    ...
    <div class="x-panel-content x-cards" xid="content1"> 
      <div component="$UI/system/components/justep/panel/panel" class="panel panel-default x-card tb-noborder media"
        ...
        <div class="media-body"> 
          <h4 class="text-black"><![CDATA[收货人：张雪莲]]></h4>  
          <h5 class="text-black"><![CDATA[收货地址：河南省焦作市高新区世纪大道2001号河南理工大学]]></h5>  
      ...
      <div> 
        <div class="col col-xs-8" xid="col7"> 
          <div class="h4 text-right" xid="div4"> 
            ...
            <span xid="span17" class="text-danger"><![CDATA[￥135]]></span> 
          </div> 
        </div>  
